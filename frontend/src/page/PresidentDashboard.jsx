...
import { ClipboardPenLine, LoaderCircle, NotebookPen, Vote } from "lucide-react";
...
function StatusBadge({ children }) {
    return (
        <span className="inline-flex rounded-full bg-emerald-50 px-2.5 py-1 text-xs font-semibold uppercase tracking-[0.08em] text-emerald-700 ring-1 ring-emerald-100">
            {children}
        </span>
    );
}
...
export default function Dashboard() {
    ...
    useEffect(() => {
        ...
        const loadPresidentDashboard = async () => {
            try {
    ...
    const mainActions = [
        {
            ...
            description: "Compartí comunicados, propuestas y novedades para mantener informado a tu barrio desde el centro vecinal.",
            icon: NotebookPen,
            imageSrc: "/publicarNota.jpg",
            imageAlt: "Publicación de notas para el barrio",
        ...
        },
        {
            ...
            description: "Gestioná las observaciones enviadas por los vecinos y dales seguimiento desde tu centro vecinal.",
            icon: ClipboardPenLine,
            imageSrc: "/atencionCliente.jpg",
            imageAlt: "Revisión de observaciones vecinales",
                ...
                <header className="flex flex-col gap-4">
                    <div>
                        <div className="flex flex-wrap items-center gap-3">
                            ...
                            <StatusBadge>Presidente</StatusBadge>
                        </div>
                        <p className="mt-2 max-w-3xl text-base leading-7 text-slate-500">
                            Accedé rápido a las acciones principales para gestionar tu centro vecinal en {auth?.barrioNombre}.
                        </p>
                    </div>
                </header>
